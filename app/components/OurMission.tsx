      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-0 md:gap-0">
          <motion.div
            ...
            className="relative flex-1 flex flex-col justify-center items-start bg-gradient-to-br from-[#ff6633]/95 to-[#ff6633]/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] rounded-l-3xl md:rounded-r-none rounded-t-3xl md:rounded-t-none p-8 sm:p-10 md:p-12 min-h-[400px] max-w-md w-full md:w-[450px] transition-all duration-500 hover:shadow-[0_12px_48px_rgba(0,0,0,0.3)]"
          >
            <motion.h2 
          ...
          <motion.div
            ...
            className="relative flex-1 flex flex-col justify-center items-start bg-gradient-to-br from-neutral-900/95 to-neutral-800/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] rounded-r-3xl md:rounded-l-none rounded-t-3xl md:rounded-t-none p-8 sm:p-10 md:p-12 min-h-[400px] max-w-md w-full md:w-[450px] transition-all duration-500 hover:shadow-[0_12px_48px_rgba(0,0,0,0.3)]"
          >
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className="text-white font-extrabold text-3xl sm:text-4xl md:text-5xl mb-8 sm:mb-12 md:mb-16 tracking-tight"
            >
              THE <br className="hidden md:block" /> VISION
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
